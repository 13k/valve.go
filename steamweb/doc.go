/*
Package steamweb provides HTTP clients for Steam API and Steam API-like endpoints.
...
Schemas and client code are generated automatically by sub-package "cmd/apigen".
